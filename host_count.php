...
<style>
    #canvasContainer {
        width: 100%;  /* Ensures the container stretches as needed */
        /*max-width: 1600px;  /* Define a max-width */
        overflow: hidden;  /* Prevents canvas from overflowing */
    }

    canvas {
        width: 100% ;  /* Force the canvas to fully fit the container */
       /* min-height: 450px !important;  /* Or any other height you prefer */
    }
</style>
</html>
...
return [
    ...
    'contract_revenue' => [
        ...
        'transform' => "var bucket = entry['contract_revenue']; var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(bucket) : null; if (useFiat) { var direct = (bucket && bucket[currency] !== undefined) ? Number(bucket[currency]) : null; if (isFinite(direct)) return direct; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (sc !== null && isFinite(r) && r > 0) ? sc * r : sc; } return sc;",
        'backgroundColor' => $palette['orange']['bg'],
        'borderColor' => $palette['orange']['border'],
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
        'decimalPlaces' => 2,
    ...
    'burned_funds' => [
        ...
        'backgroundColor' => $palette['pink']['bg'],
        'borderColor' => $palette['pink']['border'],
        'transform' => "var bucket = entry['burned_funds']; var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(bucket) : null; if (useFiat) { var direct = (bucket && bucket[currency] !== undefined) ? Number(bucket[currency]) : null; if (isFinite(direct)) return direct; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (sc !== null && isFinite(r) && r > 0) ? sc * r : sc; } return sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'renter_collateral_locked' => [
        ...
        'backgroundColor' => $palette['purple']['bg'],
        'borderColor' => $palette['purple']['border'],
        'transform' => "var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(entry['renter_collateral_locked']) : null; if (sc === null) return null; if (!useFiat) return sc; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (isFinite(r) && r > 0) ? sc * r : sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'host_collateral_locked' => [
        ...
        'backgroundColor' => $palette['orange']['bg'],
        'borderColor' => $palette['orange']['border'],
        'transform' => "var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(entry['host_collateral_locked']) : null; if (sc === null) return null; if (!useFiat) return sc; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (isFinite(r) && r > 0) ? sc * r : sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'total_burned_funds' => [
        ...
        'backgroundColor' => $palette['pink']['bg'],
        'borderColor' => $palette['pink']['border'],
        'transform' => "var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(entry['total_burned_funds']) : null; if (sc === null) return null; if (!useFiat) return sc; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (isFinite(r) && r > 0) ? sc * r : sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'avg_storage_price' => [
        ...
        'backgroundColor' => $palette['teal']['bg'],
        'borderColor' => $palette['teal']['border'],
        // Convert to SC per TB-month, or to fiat using host-local then global historical rates.
        'transform' => "var v = (entry['avg_storage_price'] / 1e12 * 4320); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'avg_upload_price' => [
        ...
        'backgroundColor' => $palette['yellow']['bg'],
        'borderColor' => $palette['yellow']['border'],
        'transform' => "var v = (entry['avg_upload_price'] / 1e12); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'avg_download_price' => [
        ...
        'backgroundColor' => $palette['pink']['bg'],
        'borderColor' => $palette['pink']['border'],
        'transform' => "var v = (entry['avg_download_price'] / 1e12); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'storage_price' => [
        ...
        'backgroundColor' => $palette['orange']['bg'],
        'borderColor' => $palette['orange']['border'],
        'transform' => "var p = entry['storage_price']; var sc = (p && p.sc !== undefined) ? p.sc : p; var v = (sc / 1e12 * 4320); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'upload_price' => [
        ...
        'backgroundColor' => $palette['purple']['bg'],
        'borderColor' => $palette['purple']['border'],
        'transform' => "var p = entry['upload_price']; var sc = (p && p.sc !== undefined) ? p.sc : p; var v = (sc / 1e12); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'download_price' => [
        ...
        'backgroundColor' => $palette['blue']['bg'],
        'borderColor' => $palette['blue']['border'],
        'transform' => "var p = entry['download_price']; var sc = (p && p.sc !== undefined) ? p.sc : p; var v = (sc / 1e12); if (!useFiat) return v; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, window.hostHistoricalRates) : null; return (isFinite(r) && r > 0) ? v * r : v;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'total_fees' => [
        ...
        'transform' => "var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(entry['total_fees']) : null; if (sc === null) return null; if (!useFiat) return sc; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (isFinite(r) && r > 0) ? sc * r : sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
    ...
    'siacoin_volume' => [
        ...
        'backgroundColor' => 'rgba(255, 159, 64, 0.2)',
        'borderColor' => 'rgba(255, 159, 64, 1)',
        'transform' => "var sc = (window.currencyDisplay && window.currencyDisplay.normalizeScValue) ? window.currencyDisplay.normalizeScValue(entry['siacoin_volume']) : null; if (sc === null) return null; if (!useFiat) return sc; var r = (window.currencyDisplay && window.currencyDisplay.resolveRateForEntryDate) ? window.currencyDisplay.resolveRateForEntryDate(entry['date'], currency, null) : null; return (isFinite(r) && r > 0) ? sc * r : sc;",
        'fiatUnit' => '__CURRENCY__',
        'scUnit' => 'SC',
        'fiatUnitDivisor' => 1,
        'scUnitDivisor' => 1,
